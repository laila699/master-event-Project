...
import 'package:event/manage_distribution_store_screen.dart'; // سنقوم بإنشاء هذا الملف قريباً
...
class _DistributionProviderDashboardScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: myDistributionStores.isEmpty // عرض رسالة إذا لم يكن هناك متاجر
          ? Center(
              child: Text(
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ManageDistributionStoreScreen(
                            distributionStore:
